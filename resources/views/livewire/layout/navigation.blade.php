                ...
                <x-wui-dropdown>
                    <x-slot name="trigger">
                        <div class="flex items-center gap-1">
                            <div primary x-data="{{ json_encode(['name' => auth()->user()->name]) }}" x-text="name"
                                x-on:profile-updated.window="name = $event.detail.name"
                                class="text-sm font-medium text-gray-500 dark:text-gray-400"></div>
                            <x-wui-icon name="chevron-down" class="w-2.5 h-2.5" />
                        </div>
                    </x-slot>
